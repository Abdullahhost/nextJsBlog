    ...
    return (
        <div className="w-full lg:w-fit mr-6 flex flex-col items-center">
            <div className="w-full md:w-3/4 mb-[20px] px-4 py-0  md:px-4  lg:max-w-[300px] md:min-w-[300px] md:mr-6 lg:mr-0">
                <h4 className=" bg-transparent text-center md:text-start px-1 md:p-2 mb-4 dark:text-white border-b-[#5555552f] dark:border-b-[#252525] border-b-2 uppercase font-bold">Categories</h4>
            ...
            <div className=" w-full md:w-3/4 my-[20px]  px-4  md:px-4  lg:max-w-[300px] md:min-w-[300px] md:mr-6 lg:mr-0">
                <h4 className=" bg-transparent text-center md:text-start  p-1 md:p-2 mb-4 dark:text-white border-b-[#5555552f] dark:border-b-[#252525] border-b-2 uppercase font-bold">Recent Five Post</h4>
